...
def test_pdmet():
    ...
    from libdmet_solid.routine.slater import get_rho_glob_R, get_rdm1_idem
    ...
    dm0 = np.zeros((2, nkpts, nao, nao), dtype=np.complex)
    ...
    for iter in range(MaxIter):
        ...
        rho_glob_R_stitched = lat.expand(rho_glob_R)
        np.save('rho_globZ', rho_glob_R_stitched)
        ...
        rho_glob_stitched = lat.expand(rho_glob)
        np.save('new_mfrdmZ', rho_glob_stitched)
