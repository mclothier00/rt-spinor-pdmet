...
from libdmet_solid.bitgen import integral_transform as trans
from libdmet_solid.bitgen import basic
...
with open("full_integral_emb_casci1.py", "w") as f:
    f.write("import numpy as np\n\n")
    f.write("def transform(v_A, v_B, u_A, u_B, h_0, h_A, h_B, D, w_A, w_B, w_AB, y_A, y_B, x):\n    ")
