...
from libdmet_solid.lo import scdm
...
class Localizer(object):
    def __init__(self, Int2e):
        """
        ER localization using Jacobi rotation.

        Args:
            Int2e[i, j, k, l] = (ij | kl), with 1-fold or 4-fold symmetry.
        """
        # ZHC TODO support ERI with symmetry
        self.Int2e = np.array(Int2e, copy=True)
    ...
    def optimize(self, thr=1e-10, MaxIter=2000):
        r"""
