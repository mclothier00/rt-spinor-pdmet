...
from libdmet_solid.solver import bcs_dmrgci, block
from libdmet_solid.solver.scf import pyscflogger, incore_transform
from libdmet_solid.routine.bcs_helper import extractRdm, combineRdm, \
...
def gen_g_hop(casscf, mo, u, casdm1s, casdm2s, eris):
    ...
    from libdmet_solid.casscf.g_hop_atomic import g_hop_atomic    
...
def kernel(casscf, mo_coeff, tol=1e-7, conv_tol_grad=None, macro=50, micro=3,
    ...
    for imacro in range(macro):
        ...
        from libdmet_solid.routine.bcs_helper import basisToCanonical, basisToSpin
...
def proj_GRho(orbs, GRho):
    from libdmet_solid.routine.bcs_helper import swapSpin
    spin = 2
    ncas = orbs.shape[2]
    norb = orbs.shape[1] // 2
...
class BCS_DMRGSCF(mc1step_uhf.CASSCF):
    ...
    def make_rdm12s(self, mo_coeff = None, ncas = None, casdm1 = None, casdm2 = None):
        ...
        from libdmet_solid.casscf.pdm_transform import cas_pdm_transform
