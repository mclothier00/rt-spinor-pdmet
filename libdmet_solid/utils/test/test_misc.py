...
def test_mdot():
    ...
    from libdmet_solid.utils import misc
...
def test_reshape():
    import numpy as np
    from libdmet_solid.utils.misc import flatten_list_of_array, \
...
def test_spin_dim():
    import numpy as np
    from libdmet_solid.utils.misc import get_spin_dim
...
def test_search_idx1d():
    import numpy as np
    from libdmet_solid.utils import search_idx1d
    a = [1, 5, 2, 3, 6, 7]
...
def test_tril_idx():
    import numpy as np
    from libdmet_solid.utils import misc
    from libdmet_solid.utils.misc import tril_idx, max_abs
...
def test_tril_take_idx():
    ...
    from libdmet_solid.utils import misc
    from libdmet_solid.utils.misc import tril_take_idx, take2d_tril, max_abs
...
def test_s4_idx():
    ...
    from pyscf import ao2mo
    from libdmet_solid.utils import misc
    from libdmet_solid.utils.misc import s4_idx, max_abs
    from libdmet_solid.system.integral import check_perm_symm
...
def test_s8_idx():
    ...
    from pyscf import ao2mo
    from libdmet_solid.utils import misc
    from libdmet_solid.utils.misc import s8_idx, max_abs
...
def test_eri_idx():
    ...
    from pyscf import ao2mo
    from libdmet_solid.utils import misc
    from libdmet_solid.utils.misc import eri_idx, max_abs
...
def test_take_eri():
    ...
    from pyscf import ao2mo
    from libdmet_solid.utils import misc
    from libdmet_solid.utils.misc import take_eri, max_abs
...
def test_cart_sph():
    ...
    from libdmet_solid.utils.misc import cart2sph, sph2cart
    x, y, z = 0.0, 0.0, 1.0
...
def test_cartesian_prod(order):
    import numpy as np
    from libdmet_solid.utils.misc import cartesian_prod, get_cart_prod_idx
...
def test_format_idx():
    from libdmet_solid.utils.misc import format_idx
