...
def test_poscar():
    ...
    from libdmet_solid.utils.iotools import read_poscar, write_poscar
...
def test_struct_dump():
    import numpy as np
    from libdmet_solid.utils.iotools import struct_dump, sc2POSCAR
    from libdmet_solid.system.lattice import Square3BandSymm
    ImpSize = [2, 2, 1]
...
def test_change_cell_shape():
    import os
    import numpy as np
    from libdmet_solid.utils.iotools import change_cell_shape
