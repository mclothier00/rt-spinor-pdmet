...
# V_site[2, 2, 4, 4] = V_site[6, 6, 8, 8] = V_site[3, 3, 5, 5] = V_site[7, 7, 9, 9] = (
#    0.1005
# )
# V_site[2, 2, 5, 5] = V_site[6, 6, 9, 9] = V_site[3, 3, 4, 4] = V_site[
#    7, 7, 8, 8
# ] = -0.1005
# V_site[2, 3, 5, 4] = V_site[6, 7, 9, 8] = V_site[3, 2, 4, 5] = V_site[7, 6, 8, 9] = (
#    -2 * 0.1
# )
