...
laser = False
# NOTE: I think this is replicating the magnetic field, but double check
m = 0.0025  # coupling between alpha and beta spin states on one spatial site
...
# run dynamics
if gen:
    h_site, V_site = make_hams.make_ham_multi_imp_anderson_realspace_mag(
        Ndots,
        NL,
        NR,
        Vg_dyn,
