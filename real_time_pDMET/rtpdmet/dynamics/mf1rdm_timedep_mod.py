...
import time
#####################################################################
## NOTE: NEED TO CHANGE, NOT SURE WHAT THIS DOES
...
def calc_Gmat(dG, system, iddt_glob1RDM):
    ...
    #G2_fast_time = time.time() (NOTE: not sure what this does; not needed)
    G2_fast = utils.rot1el(iddt_glob1RDM, system.NOevecs)
    for a in range(system.Nsites): # should this be changed to Nsites*2?
