...
class LatticePlot(object):
    def __init__(self, latt, fig=None, ax=None, linewidth=1.0):
        """
    ...
    def plot_name(self, coord, name, fontsize=15, **kwargs):
        ...
        """
        plt.text(coord[0], coord[1], name, horizontalalignment='center', \
...
if __name__ == '__main__':
    import numpy as np
    from libdmet_solid.utils import lattice_plot
    from libdmet_solid.system import lattice
