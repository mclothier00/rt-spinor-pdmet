...
def make_ham_multi_imp_anderson_realspace( Nimp, NL, NR, Vg, U, timp, timplead, Vbias, imp_indx, tleads=1.0, boundary=False, Full=False ):
...
#####################################################################
def make_ham_multi_imp_anderson_realspace_laser( N, U, laser, laser_sites=None, imp_indx=None,  t=1.0, update=False, boundary=False, Full=False ):
